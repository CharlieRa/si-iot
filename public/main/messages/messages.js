  ...
  angular.module('yelling.messages', ['ui.router', 'ngMaterial', 'ngMessages', 'ngAnimate'])
    .controller('messagesCtrl', messageCtrl);

    /**
    * Controller de Messages
    **/
    function messageCtrl($scope, $http, $timeout, User, $location, $mdDialog, $mdToast, $rootScope)
    {
      var lastServerData;
      $scope.errorMessage = "";
      $scope.messages = [];
